...
public class DeadlockSimulationTest {
    ...
    private Transaction getFirstTransaction() {
        ...
        operation.setAction(() -> {
            logger.debug("Executing first operation of transaction " + transaction.getId());
            try {
                Thread.sleep(1000);
        ...
        operation2.setAction(() -> logger.debug("Executing second operation of transaction " + transaction.getId()));
